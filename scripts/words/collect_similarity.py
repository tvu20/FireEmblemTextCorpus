...
with open(os.path.join(__location__, "similarity.txt"), 'r') as fmatrix, open(os.path.join(__location__, "links.json"), 'w') as fo:
    ...
    while line != "":
        ...
        for i, cell in enumerate(row[1:]):
            ...
            if (name_1, name_2) not in pairs and (name_2, name_1) not in pairs:
                ...
                file_content["links"].append({"source": name_1, "target": name_2, "value": cell})
